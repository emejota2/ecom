...
const Modals = () => {
  const { edad, setEdad } = useContext(Context);
    ...
    <>
      ...
      >
        <Modal.Header closeButton className="modalbody">
          <Modal.Title>
            <h4 className="modaltitulo">BIENVENIDO</h4>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <h4 className="modaltext">
            ...
            to browse our website you accept our Cookie Policy.
          </h4>
        </Modal.Body>
        <Modal.Footer>
